...
PARAM <- list()
PARAM$experimento <- "ZZ6610_ninguno10semillas"
PARAM$exp_input <- "HT6510_ninguno"
...
PARAM$semillas <- c(104311, 103903, 102871, 104287, 103319, 700561, 333233, 911111, 311111, 301057)
